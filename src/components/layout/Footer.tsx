      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="lg:col-span-1">
            ...
            <p className="text-neutral-400 text-sm mb-6">{t('footer.description')}</p>
            <div className="flex space-x-3">
              <a href="#" className="w-10 h-10 bg-neutral-800 hover:bg-primary-500 rounded-lg flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-neutral-400 hover:text-primary-400 transition-colors text-sm">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <form className="mb-6">
              <div className="flex">
                <input type="email" placeholder={t('footer.newsletter.placeholder')} className="flex-1 px-4 py-2.5 bg-neutral-800 border border-neutral-700 rounded-l-lg text-white placeholder:text-neutral-500 focus:outline-none focus:border-primary-500" />
                <button type="submit" className="px-4 py-2.5 bg-primary-500 hover:bg-primary-600 rounded-r-lg transition-colors font-medium">
                  {t('footer.newsletter.submit')}
                </button>
              </div>
            </form>
            <div className="space-y-3">
              <a href="mailto:info@medlinker.it" className="flex items-center space-x-2 text-neutral-400 hover:text-primary-400 transition-colors text-sm">
