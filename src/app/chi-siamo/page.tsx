...
export default function ChiSiamo() {
  ...
  const milestones = [
    { year: '2023', title: 'Fondazione', description: 'Nasce MediLinker con la missione di rivoluzionare il recruiting sanitario' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-neutral-600">
                MediLinker nasce per colmare questo gap, creando una piattaforma che semplifica
      ...
      <section className="section-padding bg-neutral-50">
        <div className="container-custom">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-neutral-600">
              Un gruppo di professionisti appassionati e dedicati alla missione di MediLinker
            </p>
          </div>
        ...
        <div className="container-custom">
          <Card className="p-8 lg:p-12 text-center bg-gradient-to-r from-primary-500 to-secondary-500">
            ...
            <p className="text-white/90 mb-8 max-w-xl mx-auto">
              ...
              in cerca di talenti, MediLinker è qui per te.
            </p>
